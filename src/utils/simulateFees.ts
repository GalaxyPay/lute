 ...
 * its surcharge is included. Mutates and returns the txns.
 */
...
export interface FeeSimTxn {
  ...
  /**
   * Placeholder signer for simulation, e.g. falconPlaceholderSigner (algod
   * prices the missing signature by scheme). Without one the txn is simulated
   * unsigned and algod fixes the signer.
   */
